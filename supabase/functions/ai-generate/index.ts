...
// CORS (loosened for DEV; tighten to your preview prod origins later)
const corsHeaders = {
...
// Tiny heuristic NLU so we can collect fields without an LLM
...
serve(async (req: Request) => {
  ...
  try {
    ...
    // Baseline chat echo (kept for quick tests)
    return new Response(
